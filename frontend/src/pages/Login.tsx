import { CheckCircle2, CloudOff, Loader2, ShieldCheck } from "lucide-react";
...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div className={rapido ? "mb-6 space-y-3" : "hidden"}>
        <SbloccoRapido
          onDisponibilita={(d) => setRapido(d !== null)}
          onSblocco={(esito, emailSalvata) => {
            if (!esito.online) setOffline(true);
            signIn(esito.session, emailSalvata);
            navigate("/");
          }}
        />
